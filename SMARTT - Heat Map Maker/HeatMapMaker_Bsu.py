...
try:   
    ...
    if fits_generated_with == 'PRISM':
        ...
        csvFile = os.path.join(csvFolder, "BsuR1-WT_AllSingleMutations_R.csv")
    ...
    if heat_range == 'default':
        if parameter_type == 'Amp':    # WT = ~58
            heat_range = [5,32]    # Color 1 range
            heat_range2 = [32, 59] # Color 2 range
            ...
            heat_range = [-17, 16]    # Color 1 range
            heat_range2 = [16,49]   # Color 2 range
        elif parameter_type == 'Ymax':    # WT = ~65
            heat_range = [16,49]    # Color 1 range
            heat_range2 = [49, 82] # Color 2 range
